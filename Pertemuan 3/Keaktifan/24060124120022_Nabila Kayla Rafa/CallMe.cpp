...
void Display(void) {
    ...
    glPushMatrix();
        ...
        glPushMatrix();
            ...
            glRotatef((GLfloat)index1, 0.0, 1.0, 0.0);
            glTranslatef(0.1, 0.0, 0.0);
            glPushMatrix(); 
            ...
            glTranslatef(0.1, 0.0, 0.0);
            glRotatef((GLfloat)index2, 0.0, 1.0, 0.0);
            ...
            glTranslatef(0.125, 0.0, 0.0);
            glRotatef((GLfloat)index3, 0.0, 1.0, 0.0);
            glTranslatef(0.15, 0.0, 0.0);
            glPushMatrix(); 
				glScalef(0.3, 0.2, 0.1); 
				glutWireCube(1.0); 
        ...
        glPushMatrix();
            ...
            glRotatef((GLfloat)middle1, 0.0, 1.0, 0.0);
            glTranslatef(0.1, 0.0, 0.0);
            glPushMatrix(); 
				glScalef(0.2, 0.2, 0.1); 
				glutWireCube(1.0); 
            ...
            glTranslatef(0.1, 0.0, 0.0); 
            glRotatef((GLfloat)middle2, 0.0, 1.0, 0.0);
            glTranslatef(0.15, 0.0, 0.0); 
            glPushMatrix(); 
				glScalef(0.3, 0.2, 0.1); 
				glutWireCube(1.0); 
            ...
            glTranslatef(0.15, 0.0, 0.0); 
            glRotatef((GLfloat)middle3, 0.0, 1.0, 0.0);
        ...
        glPushMatrix();
            glTranslatef(0.3, -0.3, 0.0); 
            glRotatef((GLfloat)pinky1, 0.0, 0.0, 1.0);
            glTranslatef(0.1, 0.0, 0.0);
            glPushMatrix(); 
				glScalef(0.2, 0.2, 0.1); 
				glutWireCube(1.0); 
            ...
            glTranslatef(0.1, 0.0, 0.0); 
            glRotatef((GLfloat)pinky2, 0.0, 0.0, 1.0);
            ...
            glTranslatef(0.09, 0.0, 0.0); 
            glRotatef((GLfloat)pinky3, 0.0, 0.0, 1.0);
            glTranslatef(0.1, 0.0, 0.0); 
            glPushMatrix(); 
				glScalef(0.2, 0.2, 0.1); 
				glutWireCube(1.0); 
...
void CallMe() {
    ...
    // Jari telunjuk, tengah, manis menekuk
    index1 = index2 = index3 = -60;
    middle1 = middle2 = middle3 = -60;
    ring1 = ring2 = ring3 = -60;
    
    // Jari kelingking tetap
    pinky1 = -25;
}
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Keaktifan - Call Me");
    glClearColor(0.0, 0.0, 0.0, 0.0);
    glutDisplayFunc(Display);
    glutReshapeFunc(Reshape);
    
    // Untuk call me manual
    glutKeyboardFunc(Keyboard);
    
    // Untuk call me otomatis
    CallMe();
