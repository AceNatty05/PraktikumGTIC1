#include <GL/glut.h>
int shoulderX = 0, shoulderY = 0, shoulderZ = 0;
int elbowY = 0, elbowZ = 0;
int telapakX = 0, telapakY = 0, telapakZ = 0;
int jempol1Y = 0, jempol1Z = 0, jempol2Y = 0;
int telunjuk1Y = 0, telunjuk1Z = 0, telunjuk2Y = 0, telunjuk3Y = 0;
int tengah1Y = 0, tengah1Z = 0, tengah2Y = 0, tengah3Y = 0;
int manis1Y = 0, manis1Z = 0, manis2Y = 0, manis3Y = 0;
int kelingking1Y = 0, kelingking1Z = 0, kelingking2Y = 0, kelingking3Y = 0;
