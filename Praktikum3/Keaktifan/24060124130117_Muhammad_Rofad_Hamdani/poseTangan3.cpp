#include <GL/glut.h>
int shoulderX = 0, shoulderY = -25, shoulderZ = -20;
int elbowY = -20, elbowZ = 30;
int telapakX = 0, telapakY = 0, telapakZ = 5;
int jempol1Y = 0, jempol1Z = 45, jempol2Y = -20;
int telunjuk1Y = 0, telunjuk1Z = 0, telunjuk2Y = 0, telunjuk3Y = 0;
int tengah1Y = 0, tengah1Z = 0, tengah2Y = 0, tengah3Y = 0;
int manis1Y = -25, manis1Z = 0, manis2Y = -80, manis3Y = -80;
int kelingking1Y = -25, kelingking1Z = 0, kelingking2Y = -80, kelingking3Y = -80;
