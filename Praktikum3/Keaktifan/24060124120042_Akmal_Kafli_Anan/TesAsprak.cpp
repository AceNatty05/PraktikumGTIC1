...
void Keyboard(unsigned char key, int x, int y) {
    switch (key) {
        ...
        case '1': // Thumbs Down ?? 
            f1 = 80; f2 = 80; f3 = 80; f4 = 80; 
            thumb = -10;   
            armRotY = 0; shoulder = 0; elbow = 0; wrist = 0;
            break;

        case '2': // Fist / Punch ???? 
            f1 = 80; f2 = 80; f3 = 80; f4 = 80; 
            thumb = 60;  
            armRotY = 0; shoulder = 10; elbow = 100; wrist = 30;
            break;

        case '3': // Pointing Left ??
            f1 = 80; f2 = 80; f3 = 80; f4 = 0; 
            thumb = -10;  
            armRotY = 180; shoulder = 0; elbow = 0; wrist = 0;
            break;
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Tangan Emoticon");
